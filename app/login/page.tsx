...
function LoginForm() {
  ...
  const [error, setError] = useState(
    searchParams.get('error') === 'no_access'
      ? 'Tu cuenta no tiene acceso. Contacta al administrador de tu organización.'
      : ''
  )
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <a href="/" className="inline-flex flex-col items-center gap-1">
            ...
            <span className="text-2xl font-black text-white tracking-tight">PYMS</span>
            <span className="text-slate-400 text-xs">por Pandaneiros</span>
          </a>
        </div>
